...
const titleText = "Free Secure Word Converter";
...
<svg width="${width}" height="${height}" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="50%" y="42%" text-anchor="middle" fill="#ffffff" font-family="Segoe UI, Arial, sans-serif" font-size="${titleSize}" font-weight="700">${titleText}</text>
