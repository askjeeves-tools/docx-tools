# Standalone docx-tools

This repository **is** the standalone export of the Word Converter tool. For install, run, build, preview, and deploy instructions, see [README.md](README.md).

## Do not

- Copy `tools/docx-tools/` from the [Ask Jeeves Modules](https://github.com/montana-digital/askjeeves-modules) monorepo — it uses `workspace:*` deps that only work inside the monorepo
